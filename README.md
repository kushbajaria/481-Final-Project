...
| Mode | Algorithm (deterministic)| Notes |
| ---- | --------- | ----- |
...
**I. Easy Mode** — You play as X against a heuristic agent (O). Good for warm-up
games; the AI can be beaten.

**II. Hard Mode** — You play as X against minimax with α-β pruning (O). The agent
plays optimally. The best you can do is draw.

**III. Agent vs Agent** — Pick a matchup and the program simulates *100* games,
...
> replays the same game *100* times.
